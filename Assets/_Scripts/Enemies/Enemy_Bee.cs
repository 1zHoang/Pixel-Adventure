...
public class Enemy_Bee : Enemy
{
    ...
    {
        Debug.Log("I create a bullet");
        EnemyBullet_Bee enemyBullet = Instantiate(bulletPrefab, gunPoint.position, Quaternion.identity);
        enemyBullet.SetupBullet(target, bulletSpeed, bulletLifeTime);
